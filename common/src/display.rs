...
impl<'a, const ROWS: usize, const COLUMNS: usize, D: PixelDisplay<ROWS, COLUMNS>>
    PixelDisplay<COLUMNS, ROWS> for RotatedDisplay<'a, COLUMNS, ROWS, D>
{
    fn set_pixel(&mut self, row: usize, col: usize, value: Pixel) {
        self.display
...
impl<'a, const ROWS: usize, const COLUMNS: usize, D: PixelDisplay<COLUMNS, ROWS>> Deref
...
impl<'a, const ROWS: usize, const COLUMNS: usize, D: PixelDisplay<COLUMNS, ROWS>> DerefMut
    for RotatedDisplay<'a, ROWS, COLUMNS, D>
{
